module RiskLevelsHelper
  ...
  def present_risk_confidence(risk_confidence)
    ...
    content_tag :div, class: 'progress' do
      content_tag :div, risk_confidence.to_s + '%', style: "width: #{risk_confidence}%", class: "progress-bar", role: "progressbar", 'aria-valuenow' => risk_confidence, 'aria-valuemin' => 0, 'aria-valuemax' => 100
    end
  end
end
