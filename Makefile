...
pull_data:
		ssh meduza@ex2.fr1.lgk.one "PGPASSWORD=${PRODUCTION_PGPASSWORD} pg_dump -U replication -h ${PRODUCTION_PGHOST} bitzlato --no-acl --no-owner -n meduza" > ./tmp/production.meduza.data.sql
