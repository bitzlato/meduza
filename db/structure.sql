...
--
-- Name: ad_rates_history_20221218; Type: TABLE; Schema: p2p; Owner: -
--

CREATE TABLE p2p.ad_rates_history_20221218 (
...
ALTER TABLE ONLY p2p.ad_rates_history ATTACH PARTITION p2p.ad_rates_history_20221218 FOR VALUES FROM ('2022-12-18 00:00:00') TO ('2022-12-19 00:00:00');
...
--
-- Name: signed_operation_request$20221121; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."signed_operation_request$20221121" (
    id bigint NOT NULL,
    user_id integer NOT NULL,
    command character varying(63) NOT NULL,
    params jsonb NOT NULL,
...
ALTER TABLE ONLY public.signed_operation_request ATTACH PARTITION public."signed_operation_request$20221121" FOR VALUES IN ('2022-11-21');
...
--
-- Name: user_token_mfa$20221214; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."user_token_mfa$20221214" (
    jwt_hash character varying(64) NOT NULL,
    user_id integer NOT NULL,
    expires_date date NOT NULL,
    expires_time time without time zone NOT NULL,
...
WITH (autovacuum_enabled='false', fillfactor='100');
ALTER TABLE ONLY public.user_token_mfa ATTACH PARTITION public."user_token_mfa$20221214" FOR VALUES IN ('2022-12-14');
...
--
-- Name: ad_rates_history_20221218 ad_rates_history_20221218_pkey; Type: CONSTRAINT; Schema: p2p; Owner: -
--

ALTER TABLE ONLY p2p.ad_rates_history_20221218
    ADD CONSTRAINT ad_rates_history_20221218_pkey PRIMARY KEY (id);
...
--
-- Name: signed_operation_request$20221121 signed_operation_request$20221121_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."signed_operation_request$20221121"
    ADD CONSTRAINT "signed_operation_request$20221121_pkey" PRIMARY KEY (expires_date, id);
...
--
-- Name: user_token_mfa$20221214 user_token_mfa$20221214_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."user_token_mfa$20221214"
    ADD CONSTRAINT "user_token_mfa$20221214_pkey" PRIMARY KEY (jwt_hash, expires_date);
...
--
-- Name: signed_operation_request$20221121_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "signed_operation_request$20221121_id_idx" ON public."signed_operation_request$20221121" USING btree (id) WHERE (confirmed_at IS NULL);
...
--
-- Name: signed_operation_request$20221121_id_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.signed_operation_request_id_idx ATTACH PARTITION public."signed_operation_request$20221121_id_idx";


--
-- Name: signed_operation_request$20221121_pkey; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.signed_operation_request_pkey ATTACH PARTITION public."signed_operation_request$20221121_pkey";
...
--
-- Name: user_token_mfa$20221214_pkey; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.user_tokens_mfa_pkey ATTACH PARTITION public."user_token_mfa$20221214_pkey";
